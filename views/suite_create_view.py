...
class CreateSuiteView:
	...
	def create_input_boxes(self, psy_test_pro_config: PsyTestProConfig) -> tuple[
		list[InputBox], list[Button], CheckBox]:
		input_boxes = []
		buttons = []
		labels = ['suiteName']
		spacing = 60
		...
		self.create_multiple_check_box = CheckBox('createMultipleSuites', x + 160 + text_width[0] / 2, y + 75,
												  active=True,
