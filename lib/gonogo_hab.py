...
def GoNoGo_Real(subject, experiment,block,number):
    ...
    D_HEADERS = ['Subject ID', 'Block', 'Number', 'Day', 'Month', 'Year', 'Hours', 'Minutes', 'Seconds', 'Trial Number', 
                 'Stimulus Onset Time', 'Trial Type', 'Spacebar Press Time',
    ...
    n_trials = 100
    start_time  = time.time() # to be set to 100
    seconds = 120
    trial_type = [''] * n_trials
    ...
    for trial in range(n_trials):
        ...
        stimulus_rect = pygame.Rect(screen_width // 2 - 50, screen_height // 2 - 50, 100, 100) # calculate shape of stimulus
